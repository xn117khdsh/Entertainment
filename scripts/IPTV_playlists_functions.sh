...
function sn() {
    curl -L -s "https://qqd10164-futtv.hf.space/playlist.m3u" > ./playlists/sn-thethao.m3u
    curl -L -s "https://qqd10164-fletcher.hf.space/playlist.m3u" | sed '1{/^#EXTM3U$/d;}' >> ./playlists/sn-thethao.m3u
}
