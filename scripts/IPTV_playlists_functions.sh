...
function sn() {
    wget "https://minhtienth15-chaytuta.hf.space/playlist.m3u" -U "OTT Navigator/1.6.9.4 (Linux;Android 12; en; 10i5hoq)" -O ./playlists/sn-thethao.m3u
    ...
    # sed -i 's/\.m3u8#EXTM3U$/.m3u8/' ./playlists/sn-thethao.m3u
    # sed -i '1,/^#EXTM3U$/{/^https:\/\//d;}' ./playlists/sn-thethao.m3u
}
